            ...
            <div className="flex flex-col bg-blue-50 w-2/3 p-2">
                            ...
                            <div className='overflow-y-scroll absolute top-0 left-0 right-0 bottom-2'>
                                {messagesWithoutDupes.map((message, index) => (
                                    <div className={`${message.sender === id ? 'text-right' : 'text-left'}`} key={index}>
                                        <div className={`${message.sender === id ? 'bg-blue-500 text-white' : 'bg-white text-gray-500'} p-2 my-2 rounded-md text-sm inline-block`} key={index}>
                                            {message.text}
                                            {message.file && (
                ...
                {!!selectedUserId && (
                    <form onSubmit={sendMessage} className='flex gap-2'>
                        ...
                        />
                        <label className='bg-blue-200 p-2 rounded-sm text-gray-500 border border-gray-300 cursor-pointer'>
